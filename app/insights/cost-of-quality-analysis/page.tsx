...
const leverIcons = {
  ...
  internalFailure: Layers,
  externalFailure: BarChart3,
} satisfies Record<string, LucideIcon>

type Lever = {
  title: string
  description: string
  icon: keyof typeof leverIcons
}
        ...
        <section className="space-y-6">
          ...
          <Card className="border-white/10 bg-white/[0.05]">
            ...
            <CardContent className="grid gap-4 md:grid-cols-3">
              {levers.map((lever) => {
                const LeverIcon = leverIcons[lever.icon]
